...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 08, 2025 at 06:43 PM
...
INSERT INTO `sensor_data` (`id`, `vehicle_id`, `temperature`, `humidity`, `ammonia`, `co2`, `dust`, `longitude`, `latitude`, `timestamp`) VALUES
(1, 'TRUCK001', 25.50, 65.20, 0.80, 420.50, 15.30, -99.99999999, 37.77490000, '2025-08-08 08:59:49'),
(2, 'CAR123', 22.80, 58.50, 1.20, 385.70, 8.90, -74.00600000, 40.71280000, '2025-08-08 09:00:39'),
(4, 'TRUCK001', 25.50, 65.20, 0.80, 420.50, 15.30, -99.99999999, 37.77490000, '2025-08-08 09:01:48'),
(5, 'TRUCK001', 25.50, 65.20, 0.80, 420.50, 15.30, -99.99999999, 37.77490000, '2025-08-08 13:09:21');
...
INSERT INTO `sensor_devices` (`id`, `sensor_id`, `serial_number`, `vehicle_reg_no`, `device_name`, `device_type`, `status`, `installation_date`, `last_calibration`, `battery_level`, `location`, `notes`, `created_at`, `updated_at`) VALUES
(1, 'Re12345k', '12345678', 'CAR123', 'sensor 1', 'Multi-Sensor', 'active', '2025-08-08', '2025-08-08', 100, 'r12371', 'hbgfvdc', '2025-08-08 12:22:16', '2025-08-08 12:22:16');
...
INSERT INTO `vehicles` (`id`, `registration_no`, `plate_number`, `fuel_type`, `vehicle_type`, `created_at`, `updated_at`) VALUES
(1, 'TRUCK001', 'raa123t', 'Diesel', 'Truck', '2025-08-08 10:20:19', '2025-08-08 10:21:35'),
(2, 'CAR123', 'raa123g', 'Electric', 'Car', '2025-08-08 10:22:12', '2025-08-08 10:22:38'),
(3, 'R_12', 'raa123h', 'Petrol', 'SUV', '2025-08-08 13:11:20', '2025-08-08 13:11:44');
...
--
-- Indexes for table `sensor_devices`
--
...
--
-- AUTO_INCREMENT for table `sensor_devices`
--
ALTER TABLE `sensor_devices`
...
--
-- Constraints for table `sensor_devices`
--
ALTER TABLE `sensor_devices`
  ADD CONSTRAINT `sensor_devices_ibfk_1` FOREIGN KEY (`vehicle_reg_no`) REFERENCES `vehicles` (`registration_no`) ON DELETE CASCADE;
COMMIT;
